 ...
 * @author Omen
 */
public class AddCurrencyHandler extends Handler{
    
    private final AddCurrency dialog;
    
    
    public AddCurrencyHandler(MainFrame frame, AddCurrency dialog) {
        super(frame);
        this.dialog = dialog;
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        switch (ae.getActionCommand()) {
            ...
            try {
                ...
                Logger.getLogger(AddCurrencyHandler.class.getName()).log(Level.SEVERE, null, ex);
            }
                break;
